 ...
 */
final class Version20220527133611 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post ADD category_id INT DEFAULT NULL, ADD profile_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post DROP category_id, DROP profile_id');
    }
}
